...
use bitview_compute::{
    CachedBlockCountReader, LazyRatioWithCachedBlockCount, LazyRollingRatioVec,
    LazyRollingRatioWithCachedBlockCount,
};
...
fn benchmark_remaining_views() {
    ...
    let cases: Vec<(&str, ReadableBoxedVec<Height, StoredU64>)> = vec![
        ...
        (
            "block_ratio",
            LazyRatioWithCachedBlockCount::<StoredU64, Ratio>::new(
                "block_ratio",
                Version::ONE,
                source.read_only_boxed_clone(),
                denominator.clone(),
        ...
        (
            "rolling_block_ratio",
            LazyRollingRatioWithCachedBlockCount::<StoredU64, Ratio>::new(
                "rolling_block_ratio",
                Version::ONE,
                source.read_only_boxed_clone(),
                denominator,
