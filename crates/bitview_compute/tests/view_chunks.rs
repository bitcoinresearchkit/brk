...
use bitview_compute::{
    CachedBlockCountReader, LazyLookbackVec, LazyPreviousDeltaVec, LazyRatioWithCachedBlockCount,
    LazyRollingRatioVec, LazyRollingRatioWithCachedBlockCount, LazySinceDayVec, LazyWindowVec,
};
...
fn ratio_chunks_match_scalar_paths_and_do_not_reenter_source_reads() {
    ...
    .enumerate()
    {
        ...
        for window in [0, 17, 20_000, 50_000] {
            ...
            let denominator = CachedBlockCountReader::new(blocks.read_only_cached_boxed_clone());
            ...
            let rolling = LazyRollingRatioWithCachedBlockCount::<StoredU64, TestRatio>::new(
                "rolling",
                Version::ONE,
                source.read_only_boxed_clone(),
                denominator.clone(),
            ...
            let cumulative = LazyRatioWithCachedBlockCount::<StoredU64, TestRatio>::new(
                "cumulative",
                Version::ONE,
                source.read_only_boxed_clone(),
                denominator,
