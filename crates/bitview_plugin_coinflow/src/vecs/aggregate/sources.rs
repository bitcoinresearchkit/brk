...
pub struct AggregateSources<M: StorageMode = Rw> {
    pub supply: Mobility<UTXOAggregate<StoredSeries<Height, Sats, M>>>,
    ...
    pub supply_in_loss_share: UTXOAggregate<StoredSeries<Height, BoundedRatio, M>>,
    ...
    pub horizon: Horizons<UTXOAggregate<StoredSeries<Height, BoundedRatio, M>>>,
    ...
    /// created.
    pub cap: UTXOAggregate<StoredSeries<Height, Cents, M>>,
    ...
    pub price: UTXOAggregate<StoredSeries<Height, Cents, M>>,
}
