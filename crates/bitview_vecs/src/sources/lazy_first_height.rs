...
/// First-height lookup derived from one monotonic height-to-period mapping.
#[derive(Clone)]
pub struct LazyFirstHeightVec<I: VecIndex> {
    mapping: ReadableBoxedVec<Height, I>,
}

impl<I: VecIndex> LazyFirstHeightVec<I> {
    pub fn new(mapping: &(impl ReadableCloneableVec<Height, I> + ?Sized)) -> Self {
        Self {
...
impl<I: VecIndex> AnyVec for LazyFirstHeightVec<I> {
...
impl<I: VecIndex> TypedVec for LazyFirstHeightVec<I> {
    type I = I;
    type T = Height;
}
...
impl<I: VecIndex> Traversable for LazyFirstHeightVec<I> {
