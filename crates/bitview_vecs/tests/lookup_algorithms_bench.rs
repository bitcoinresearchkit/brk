...
use bitview_vecs::{
    CumulativeCountVec, DailyView, LastDay, LazyLookbackVec, LazyRollingRatioVec, LazyWindowVec,
    RepeatDay,
};
...
fn benchmark_lookup_algorithms() {
    ...
    for resident in [false, true] {
        ...
        let denominator = CumulativeCountVec::new(counts.read_only_cached_boxed_clone());
