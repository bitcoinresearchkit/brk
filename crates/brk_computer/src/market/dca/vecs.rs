...
use crate::internal::{BinaryDateLast, ComputedDateLast, ValueDateLast};
...
pub struct Vecs {
    ...
    pub period_returns: ByDcaPeriod<BinaryDateLast<StoredF32, Close<Dollars>, Dollars>>,
    ...
    pub class_returns: ByDcaClass<BinaryDateLast<StoredF32, Close<Dollars>, Dollars>>,
}
