...
use crate::internal::LazyFromDateLast;

/// Price volatility metrics (derived from returns standard deviation)
#[derive(Clone, Traversable)]
pub struct Vecs {
    pub price_1w_volatility: LazyFromDateLast<StoredF32>,
    pub price_1m_volatility: LazyFromDateLast<StoredF32>,
    pub price_1y_volatility: LazyFromDateLast<StoredF32>,
