...
function _endpoint(client, name, index) {
   ...
   */
  const toBuilder = (end) => ({
    takeLast(/** @type {number} */ n) {
      return rangeBuilder(end - n, end);
    },
    from(/** @type {number} */ start) {
      return rangeBuilder(start, end);
    },
    json(/** @type {((value: MetricData<T>) => void) | undefined} */ onUpdate) {
    ...
    csv() {
      return client.getText(buildPath(undefined, end, "csv"));
    },
  });
  ...
  return {
    ...
    last(/** @type {number} */ n) {
      return rangeBuilder(-n, undefined);
    },
    range(/** @type {number} */ start, /** @type {number} */ end) {
      return rangeBuilder(start, end);
    },
    from(/** @type {number} */ start) {
      return fromBuilder(start);
    },
    to(/** @type {number} */ end) {
      return toBuilder(end);
    },
    json(/** @type {((value: MetricData<T>) => void) | undefined} */ onUpdate) {
...
/**
 * @template T
 * @typedef {{ name: string, by: { dateindex: MetricEndpointBuilder<T>, decadeindex: MetricEndpointBuilder<T>, difficultyepoch: MetricEndpointBuilder<T>, height: MetricEndpointBuilder<T>, monthindex: MetricEndpointBuilder<T>, quarterindex: MetricEndpointBuilder<T>, semesterindex: MetricEndpointBuilder<T>, weekindex: MetricEndpointBuilder<T>, yearindex: MetricEndpointBuilder<T> }, indexes: () => Index[], get: (index: Index) => MetricEndpointBuilder<T>|undefined }} MetricPattern1
 */
...
/**
 * @template T
 * @typedef {{ name: string, by: { dateindex: MetricEndpointBuilder<T>, decadeindex: MetricEndpointBuilder<T>, difficultyepoch: MetricEndpointBuilder<T>, monthindex: MetricEndpointBuilder<T>, quarterindex: MetricEndpointBuilder<T>, semesterindex: MetricEndpointBuilder<T>, weekindex: MetricEndpointBuilder<T>, yearindex: MetricEndpointBuilder<T> }, indexes: () => Index[], get: (index: Index) => MetricEndpointBuilder<T>|undefined }} MetricPattern2
 */
...
/**
 * @template T
 * @typedef {{ name: string, by: { dateindex: MetricEndpointBuilder<T>, decadeindex: MetricEndpointBuilder<T>, height: MetricEndpointBuilder<T>, monthindex: MetricEndpointBuilder<T>, quarterindex: MetricEndpointBuilder<T>, semesterindex: MetricEndpointBuilder<T>, weekindex: MetricEndpointBuilder<T>, yearindex: MetricEndpointBuilder<T> }, indexes: () => Index[], get: (index: Index) => MetricEndpointBuilder<T>|undefined }} MetricPattern3
 */
...
/**
 * @template T
 * @typedef {{ name: string, by: { dateindex: MetricEndpointBuilder<T>, decadeindex: MetricEndpointBuilder<T>, monthindex: MetricEndpointBuilder<T>, quarterindex: MetricEndpointBuilder<T>, semesterindex: MetricEndpointBuilder<T>, weekindex: MetricEndpointBuilder<T>, yearindex: MetricEndpointBuilder<T> }, indexes: () => Index[], get: (index: Index) => MetricEndpointBuilder<T>|undefined }} MetricPattern4
 */
...
/**
 * @template T
 * @typedef {{ name: string, by: { dateindex: MetricEndpointBuilder<T>, height: MetricEndpointBuilder<T> }, indexes: () => Index[], get: (index: Index) => MetricEndpointBuilder<T>|undefined }} MetricPattern5
 */
...
/**
 * @template T
 * @typedef {{ name: string, by: { dateindex: MetricEndpointBuilder<T> }, indexes: () => Index[], get: (index: Index) => MetricEndpointBuilder<T>|undefined }} MetricPattern6
 */
...
/**
 * @template T
 * @typedef {{ name: string, by: { decadeindex: MetricEndpointBuilder<T> }, indexes: () => Index[], get: (index: Index) => MetricEndpointBuilder<T>|undefined }} MetricPattern7
 */
...
/**
 * @template T
 * @typedef {{ name: string, by: { difficultyepoch: MetricEndpointBuilder<T> }, indexes: () => Index[], get: (index: Index) => MetricEndpointBuilder<T>|undefined }} MetricPattern8
 */
...
/**
 * @template T
 * @typedef {{ name: string, by: { emptyoutputindex: MetricEndpointBuilder<T> }, indexes: () => Index[], get: (index: Index) => MetricEndpointBuilder<T>|undefined }} MetricPattern9
 */
...
/**
 * @template T
 * @typedef {{ name: string, by: { halvingepoch: MetricEndpointBuilder<T> }, indexes: () => Index[], get: (index: Index) => MetricEndpointBuilder<T>|undefined }} MetricPattern10
 */
...
/**
 * @template T
 * @typedef {{ name: string, by: { height: MetricEndpointBuilder<T> }, indexes: () => Index[], get: (index: Index) => MetricEndpointBuilder<T>|undefined }} MetricPattern11
 */
...
/**
 * @template T
 * @typedef {{ name: string, by: { txinindex: MetricEndpointBuilder<T> }, indexes: () => Index[], get: (index: Index) => MetricEndpointBuilder<T>|undefined }} MetricPattern12
 */
...
/**
 * @template T
 * @typedef {{ name: string, by: { monthindex: MetricEndpointBuilder<T> }, indexes: () => Index[], get: (index: Index) => MetricEndpointBuilder<T>|undefined }} MetricPattern13
 */
...
/**
 * @template T
 * @typedef {{ name: string, by: { opreturnindex: MetricEndpointBuilder<T> }, indexes: () => Index[], get: (index: Index) => MetricEndpointBuilder<T>|undefined }} MetricPattern14
 */
...
/**
 * @template T
 * @typedef {{ name: string, by: { txoutindex: MetricEndpointBuilder<T> }, indexes: () => Index[], get: (index: Index) => MetricEndpointBuilder<T>|undefined }} MetricPattern15
 */
...
/**
 * @template T
 * @typedef {{ name: string, by: { p2aaddressindex: MetricEndpointBuilder<T> }, indexes: () => Index[], get: (index: Index) => MetricEndpointBuilder<T>|undefined }} MetricPattern16
 */
...
/**
 * @template T
 * @typedef {{ name: string, by: { p2msoutputindex: MetricEndpointBuilder<T> }, indexes: () => Index[], get: (index: Index) => MetricEndpointBuilder<T>|undefined }} MetricPattern17
 */
...
/**
 * @template T
 * @typedef {{ name: string, by: { p2pk33addressindex: MetricEndpointBuilder<T> }, indexes: () => Index[], get: (index: Index) => MetricEndpointBuilder<T>|undefined }} MetricPattern18
 */
...
/**
 * @template T
 * @typedef {{ name: string, by: { p2pk65addressindex: MetricEndpointBuilder<T> }, indexes: () => Index[], get: (index: Index) => MetricEndpointBuilder<T>|undefined }} MetricPattern19
 */
...
/**
 * @template T
 * @typedef {{ name: string, by: { p2pkhaddressindex: MetricEndpointBuilder<T> }, indexes: () => Index[], get: (index: Index) => MetricEndpointBuilder<T>|undefined }} MetricPattern20
 */
...
/**
 * @template T
 * @typedef {{ name: string, by: { p2shaddressindex: MetricEndpointBuilder<T> }, indexes: () => Index[], get: (index: Index) => MetricEndpointBuilder<T>|undefined }} MetricPattern21
 */
...
/**
 * @template T
 * @typedef {{ name: string, by: { p2traddressindex: MetricEndpointBuilder<T> }, indexes: () => Index[], get: (index: Index) => MetricEndpointBuilder<T>|undefined }} MetricPattern22
 */
...
/**
 * @template T
 * @typedef {{ name: string, by: { p2wpkhaddressindex: MetricEndpointBuilder<T> }, indexes: () => Index[], get: (index: Index) => MetricEndpointBuilder<T>|undefined }} MetricPattern23
 */
...
/**
 * @template T
 * @typedef {{ name: string, by: { p2wshaddressindex: MetricEndpointBuilder<T> }, indexes: () => Index[], get: (index: Index) => MetricEndpointBuilder<T>|undefined }} MetricPattern24
 */
...
/**
 * @template T
 * @typedef {{ name: string, by: { quarterindex: MetricEndpointBuilder<T> }, indexes: () => Index[], get: (index: Index) => MetricEndpointBuilder<T>|undefined }} MetricPattern25
 */
...
/**
 * @template T
 * @typedef {{ name: string, by: { semesterindex: MetricEndpointBuilder<T> }, indexes: () => Index[], get: (index: Index) => MetricEndpointBuilder<T>|undefined }} MetricPattern26
 */
...
/**
 * @template T
 * @typedef {{ name: string, by: { txindex: MetricEndpointBuilder<T> }, indexes: () => Index[], get: (index: Index) => MetricEndpointBuilder<T>|undefined }} MetricPattern27
 */
...
/**
 * @template T
 * @typedef {{ name: string, by: { unknownoutputindex: MetricEndpointBuilder<T> }, indexes: () => Index[], get: (index: Index) => MetricEndpointBuilder<T>|undefined }} MetricPattern28
 */
...
/**
 * @template T
 * @typedef {{ name: string, by: { weekindex: MetricEndpointBuilder<T> }, indexes: () => Index[], get: (index: Index) => MetricEndpointBuilder<T>|undefined }} MetricPattern29
 */
...
/**
 * @template T
 * @typedef {{ name: string, by: { yearindex: MetricEndpointBuilder<T> }, indexes: () => Index[], get: (index: Index) => MetricEndpointBuilder<T>|undefined }} MetricPattern30
 */
...
/**
 * @template T
 * @typedef {{ name: string, by: { loadedaddressindex: MetricEndpointBuilder<T> }, indexes: () => Index[], get: (index: Index) => MetricEndpointBuilder<T>|undefined }} MetricPattern31
 */
...
/**
 * @template T
 * @typedef {{ name: string, by: { emptyaddressindex: MetricEndpointBuilder<T> }, indexes: () => Index[], get: (index: Index) => MetricEndpointBuilder<T>|undefined }} MetricPattern32
 */
 ...
 * @property {MetricsTree_Blocks_Interval} interval
...
/**
 * @typedef {Object} MetricsTree_Blocks_Interval
 ...
 * @property {MetricsTree_Distribution_AddrCount} addrCount
 ...
 * @property {MetricsTree_Distribution_EmptyAddrCount} emptyAddrCount
...
/**
 * @typedef {Object} MetricsTree_Distribution_AddrCount
 * @property {MetricPattern1<StoredU64>} all
 * @property {MetricPattern1<StoredU64>} p2a
 * @property {MetricPattern1<StoredU64>} p2pk33
 * @property {MetricPattern1<StoredU64>} p2pk65
...
/**
 * @typedef {Object} MetricsTree_Distribution_EmptyAddrCount
 * @property {MetricPattern1<StoredU64>} all
 * @property {MetricPattern1<StoredU64>} p2a
 * @property {MetricPattern1<StoredU64>} p2pk33
 * @property {MetricPattern1<StoredU64>} p2pk65
 ...
 * @property {MetricsTree_Market_Lookback_PriceAgo} priceAgo
 */

/**
 * @typedef {Object} MetricsTree_Market_Lookback_PriceAgo
