...
class DataRangeFormat(TypedDict):
    ...
    Attributes:
        ...
        count: Number of values to return (ignored if `end` is set)
...
class MetricsTree_Distribution_UtxoCohorts_All:
    ...
    def __init__(self, client: BrkClientBase, base_path: str = ''):
        self.activity: ActivityPattern2 = ActivityPattern2(client, 'coinblocks_destroyed')
...
class BrkClient(BrkClientBase):
    ...
    def get_metric_by_index(self, metric: Metric, index: Index, start: Optional[float] = None, end: Optional[float] = None, count: Optional[float] = None, format: Optional[Format] = None) -> Union[AnyMetricData, str]:
        """Get metric data.
    ...
    def get_metrics_bulk(self, metrics: Metrics, index: Index, start: Optional[float] = None, end: Optional[float] = None, count: Optional[float] = None, format: Optional[Format] = None) -> Union[List[AnyMetricData], str]:
        """Bulk metric data.
    ...
    def get_metrics_list(self, page: Optional[float] = None) -> PaginatedMetrics:
        """Metrics list.
