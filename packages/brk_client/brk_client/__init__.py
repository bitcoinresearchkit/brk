...
class ToBuilder(Generic[T]):
    ...
    def take_last(self, n: int) -> RangeBuilder[T]:
        ...
        return RangeBuilder(
            _EndpointConfig(
                self._config.client, self._config.name, self._config.index, end - n, end
            )
        )
...
class MetricEndpointBuilder(Generic[T]):
    ...
    def from_(self, start: int) -> FromBuilder[T]:
        ...
        return FromBuilder(
            _EndpointConfig(
                self._config.client, self._config.name, self._config.index, start, None
            )
        )
    ...
    def to(self, end: int) -> ToBuilder[T]:
        ...
        return ToBuilder(
            _EndpointConfig(
                self._config.client, self._config.name, self._config.index, None, end
            )
        )
