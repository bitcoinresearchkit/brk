...
class RealizedPattern3:
    ...
    def __init__(self, client: BrkClientBase, acc: str):
        ...
        self.realized_price: ActivePricePattern = ActivePricePattern(
...
class CostBasisPattern2:
    ...
    def __init__(self, client: BrkClientBase, acc: str):
        """Create pattern node with accumulated metric name."""
        self.max: ActivePricePattern = ActivePricePattern(
...
class MetricsTree_Cointime_Pricing:
    ...
    def __init__(self, client: BrkClientBase, base_path: str = ""):
        self.active_price: ActivePricePattern = ActivePricePattern(
            client, "active_price"
        )
        self.active_price_ratio: ActivePriceRatioPattern = ActivePriceRatioPattern(
            client, "active_price_ratio"
        )
        self.cointime_price: ActivePricePattern = ActivePricePattern(
        ...
        self.true_market_mean: ActivePricePattern = ActivePricePattern(
        ...
        self.vaulted_price: ActivePricePattern = ActivePricePattern(
...
class MetricsTree_Constants:
    ...
    def __init__(self, client: BrkClientBase, base_path: str = ""):
        ...
        self.constant_minus_1: MetricPattern1[StoredI8] = MetricPattern1(
            client, "constant_minus_1"
        )
        self.constant_minus_2: MetricPattern1[StoredI8] = MetricPattern1(
            client, "constant_minus_2"
        )
        self.constant_minus_3: MetricPattern1[StoredI8] = MetricPattern1(
            client, "constant_minus_3"
        )
        self.constant_minus_4: MetricPattern1[StoredI8] = MetricPattern1(
...
class MetricsTree_Distribution_UtxoCohorts_AgeRange:
    ...
    def __init__(self, client: BrkClientBase, base_path: str = ""):
        ...
        self._7y_to_8y: _10yTo12yPattern = _10yTo12yPattern(
            client, "utxos_7y_to_8y_old"
        )
        self._8y_to_10y: _10yTo12yPattern = _10yTo12yPattern(
            client, "utxos_8y_to_10y_old"
        )
...
class MetricsTree_Market_Dca:
    ...
    def __init__(self, client: BrkClientBase, base_path: str = ""):
        ...
        self.class_days_in_loss: MetricsTree_Market_Dca_ClassDaysInLoss = (
            MetricsTree_Market_Dca_ClassDaysInLoss(client)
        )
        ...
        self.period_average_price: MetricsTree_Market_Dca_PeriodAveragePrice = (
            MetricsTree_Market_Dca_PeriodAveragePrice(client)
        )
        ...
        self.period_max_drawdown: PeriodDaysInLossPattern[StoredF32] = (
            PeriodDaysInLossPattern(client, "dca_max_drawdown")
        )
...
class MetricsTree_Market_MovingAverage:
    ...
    def __init__(self, client: BrkClientBase, base_path: str = ""):
        ...
        self.price_200d_sma_x0_8: _0sdUsdPattern = _0sdUsdPattern(
            client, "price_200d_sma_x0_8"
        )
        self.price_200d_sma_x2_4: _0sdUsdPattern = _0sdUsdPattern(
        ...
        self.price_350d_sma_x2: _0sdUsdPattern = _0sdUsdPattern(
...
class BrkClient(BrkClientBase):
    ...
    AGE_RANGE_NAMES = {
        "up_to_1h": {"id": "under_1h_old", "short": "<1h", "long": "Under 1 Hour Old"},
        "_1h_to_1d": {
            "id": "1h_to_1d_old",
            "short": "1h-1d",
        ...
        "from_15y": {"id": "over_15y_old", "short": "15y+", "long": "15+ Years Old"},
    }

    MAX_AGE_NAMES = {
        "_1w": {"id": "under_1w_old", "short": "<1w", "long": "Under 1 Week Old"},
        "_1m": {"id": "under_1m_old", "short": "<1m", "long": "Under 1 Month Old"},
        "_2m": {"id": "under_2m_old", "short": "<2m", "long": "Under 2 Months Old"},
        "_3m": {"id": "under_3m_old", "short": "<3m", "long": "Under 3 Months Old"},
        "_4m": {"id": "under_4m_old", "short": "<4m", "long": "Under 4 Months Old"},
        "_5m": {"id": "under_5m_old", "short": "<5m", "long": "Under 5 Months Old"},
        "_6m": {"id": "under_6m_old", "short": "<6m", "long": "Under 6 Months Old"},
        "_1y": {"id": "under_1y_old", "short": "<1y", "long": "Under 1 Year Old"},
        "_2y": {"id": "under_2y_old", "short": "<2y", "long": "Under 2 Years Old"},
        "_3y": {"id": "under_3y_old", "short": "<3y", "long": "Under 3 Years Old"},
        "_4y": {"id": "under_4y_old", "short": "<4y", "long": "Under 4 Years Old"},
        "_5y": {"id": "under_5y_old", "short": "<5y", "long": "Under 5 Years Old"},
        "_6y": {"id": "under_6y_old", "short": "<6y", "long": "Under 6 Years Old"},
        "_7y": {"id": "under_7y_old", "short": "<7y", "long": "Under 7 Years Old"},
        "_8y": {"id": "under_8y_old", "short": "<8y", "long": "Under 8 Years Old"},
        "_10y": {"id": "under_10y_old", "short": "<10y", "long": "Under 10 Years Old"},
        "_12y": {"id": "under_12y_old", "short": "<12y", "long": "Under 12 Years Old"},
        "_15y": {"id": "under_15y_old", "short": "<15y", "long": "Under 15 Years Old"},
    }

    MIN_AGE_NAMES = {
        "_1d": {"id": "over_1d_old", "short": "1d+", "long": "Over 1 Day Old"},
        "_1w": {"id": "over_1w_old", "short": "1w+", "long": "Over 1 Week Old"},
        "_1m": {"id": "over_1m_old", "short": "1m+", "long": "Over 1 Month Old"},
        "_2m": {"id": "over_2m_old", "short": "2m+", "long": "Over 2 Months Old"},
        "_3m": {"id": "over_3m_old", "short": "3m+", "long": "Over 3 Months Old"},
        "_4m": {"id": "over_4m_old", "short": "4m+", "long": "Over 4 Months Old"},
        "_5m": {"id": "over_5m_old", "short": "5m+", "long": "Over 5 Months Old"},
        "_6m": {"id": "over_6m_old", "short": "6m+", "long": "Over 6 Months Old"},
        "_1y": {"id": "over_1y_old", "short": "1y+", "long": "Over 1 Year Old"},
        "_2y": {"id": "over_2y_old", "short": "2y+", "long": "Over 2 Years Old"},
        "_3y": {"id": "over_3y_old", "short": "3y+", "long": "Over 3 Years Old"},
        "_4y": {"id": "over_4y_old", "short": "4y+", "long": "Over 4 Years Old"},
        "_5y": {"id": "over_5y_old", "short": "5y+", "long": "Over 5 Years Old"},
        "_6y": {"id": "over_6y_old", "short": "6y+", "long": "Over 6 Years Old"},
        "_7y": {"id": "over_7y_old", "short": "7y+", "long": "Over 7 Years Old"},
        "_8y": {"id": "over_8y_old", "short": "8y+", "long": "Over 8 Years Old"},
        "_10y": {"id": "over_10y_old", "short": "10y+", "long": "Over 10 Years Old"},
        "_12y": {"id": "over_12y_old", "short": "12y+", "long": "Over 12 Years Old"},
    }
    ...
    GE_AMOUNT_NAMES = {
        "_1sat": {"id": "over_1sat", "short": "1+ sats", "long": "Over 1 Sat"},
        "_10sats": {"id": "over_10sats", "short": "10+ sats", "long": "Over 10 Sats"},
        "_100sats": {
            "id": "over_100sats",
            "short": "100+ sats",
            "long": "Over 100 Sats",
