 ...
 * ```
 */
export declare function createImageWatermark<T>(
  pane: IPaneApi<T>,
  imageUrl: string,
 ...
 */
export declare function createOptionsChart(
  container: string | HTMLElement,
 ...
 * ```
 */
export declare function createSeriesMarkers<HorzScaleItem>(
 ...
 * ```
 */
export declare function createTextWatermark<T>(
  pane: IPaneApi<T>,
 ...
 * ```
 */
export declare function createUpDownMarkers<T>(
 ...
 * @returns An interface to the created chart
 */
export declare function createYieldCurveChart(
  container: string | HTMLElement,
...
export interface ISeriesUpDownMarkerPluginApi<
  HorzScaleItem,
  TData extends
    SeriesDataItemTypeMap<HorzScaleItem>[UpDownMarkersSupportedSeriesTypes] = SeriesDataItemTypeMap<HorzScaleItem>["Line"],
> extends ISeriesPrimitiveWrapper<HorzScaleItem> {
  /**
 ...
 */
export interface IYieldCurveChartApi
  extends Omit<IChartApiBase<number>, "addSeries"> {
  /**
   * Creates a series with specified parameters.
   *
...
export interface SeriesMarkerPrice<TimeType>
  extends SeriesMarkerBase<TimeType> {
  /**
   * The position of the marker.
   */
...
export interface TouchMouseEventData {
  ...
  /**
   * Returns a boolean value that is true if the Alt (Option or âŒ¥ on macOS) key was active when the
  ...
  /**
   * Returns a boolean value that is true if the Meta key (on Mac keyboards, the âŒ˜ Command key; on
   * Windows keyboards, the Windows key (âŠž)) was active when the key event was generated.
   */
...
export type IImageWatermarkPluginApi<T> = PrimitiveHasApplyOptions<
  IPanePrimitiveWrapper<T, ImageWatermarkOptions>
>;
/**
...
>;
export type ITextWatermarkPluginApi<T> = PrimitiveHasApplyOptions<
  IPanePrimitiveWrapper<T, TextWatermarkOptions>
>;
/**
 ...
 */
export type PrimitiveHasApplyOptions<
  T extends {
    /**
...
export type SeriesMarker<TimeType> =
  | SeriesMarkerBar<TimeType>
  | SeriesMarkerPrice<TimeType>;
/**
 ...
 */
export type SeriesMarkerPricePosition =
  | "atPriceTop"
  | "atPriceBottom"
  | "atPriceMiddle";
/**
...
export type TickmarksPercentageFormatterFn = (
